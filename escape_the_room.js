...
/**
 * Try to use item on an RoomObjectpen
 * @param  {string} itemName
 * @param  {string} objectName
 * @return {string}
 */
...
var drawer = new RoomObject(
        'drawer', 
        'This may contain useful items.', 
        ['scissors','cloth','pencil', 'flashlight'],
        [], 
        ['open', 'check','get']
);
var ottoman = new RoomObject('ottoman', 
        'Dusty but this can be opened, or sit on it if you are tired.', 
        ['candles', 'photo', 'magazines', 'lamp'], 
        ['cloth'],
        ['open', 'examine', 'get', 'check']
);
var table = new RoomObject('table', 
        'You will see things on it with some light, but not food.', 
        ['book', 'candles','vase'], 
        ['lamp'], 
        ['check', 'read', 'open']
);
var couch = new RoomObject(
        'couch', 
        'Not comfy but you may sleep on it and look under it.', 
        ['crumbs', 'dust', 'shoe','rat'], 
        [], 
        'check'
);
var cloth = new RoomObject(
        'cloth',
        'To clean other furnitures.',
        [],
        [],
        ['use', 'examine']
)
var lamp = new RoomObject(
        'lamp',
        'plug and use.',
        [],
        [],
...
var Door = new RoomObject(
        'Door',
        'Metal door that is locked.',
        [],
        ['key'],
        ['open', 'unlock']
);
var roomObjects = [drawer, ottoman, table, couch, book, Door]

// Create an array of Room objects
var livingRoom = new Room(roomObjects)
var arrayOfRooms = [livingRoom]

// Create a new Game

var game = new Game([livingRoom])
